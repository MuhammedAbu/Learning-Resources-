...
- .git folder
  ...
  - In linux, if you want to remove the link from a locally initialized or cloned git repo to github, you can do so by removing the .git folder located in the root directory of the cloned or initialized repo. Run the command `rm -rf .git` to 
